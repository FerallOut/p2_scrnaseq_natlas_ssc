...
ggsave(filename = paste0(output_dirs[2], "05_ridgeplot_sampleComplexity_unfilt_", tstamp, ".pdf"),
       plot = p,
       device = "pdf",
       height = 16,
       width = 16)
...
fp3.violinplot(seu_merge_unfilt, 
               ...
               diam = 0,
               str_plt_nr = "05_",
               str_subtitle = "VlnPlot_sampleComplexity_unfilt_") +
...
lapply(c("nFeature_RNA", "nCount_RNA", "percent.mt"), 
       function(X) fp3.violinplot(seu_merge_filt, 
                                  to_plot = X,
                                  to_group = "abrev_name", 
                                  to_split = "abrev_name", 
                                  log_switch = T,
                                  diam = 0,
                                  str_plt_nr = "06_",  # which(x %in% c(2,4))
                                  str_subtitle = paste0("VlnPlot_features_counts_mt_filt_", X),
                                  out_dir = output_dirs[2]
                                  ) )
```
...
ggsave(filename = paste0(output_dirs[2], "09_ridgeplot_nFeature_filt_", tstamp, ".pdf"),
       plot = p,
       device = "pdf",
       height = 16,
       width = 16)
...
ggsave(filename = paste0(output_dirs[2], "10_ridgeplot_sampleComplexity_unfilt_", tstamp, ".pdf"),
       plot = p,
       device = "pdf",
       height = 16,
       width = 16)
