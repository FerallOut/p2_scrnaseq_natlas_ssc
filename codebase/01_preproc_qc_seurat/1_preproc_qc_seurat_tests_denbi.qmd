...
fp3.violinplot(seu_merge_unfilt, 
               ...
               diam = 0,
               str_plt_nr = "01_",
               str_subtitle = "VlnPlot_features_counts_mt_unfilt_"
               )
```
...
ggsave(filename = paste0(output_dirs[2], "histogram_nCount_unfilt.pdf"),                                                                                    
       plot = p,
       device = "pdf",
       height = 8,
       width = 16)
...
ggsave(filename = paste0(output_dirs[2], "histogram_nFeature_unfilt.pdf"),                                                                                    
       plot = q,
       device = "pdf",
       height = 8,
       width = 16)
